<x-layout>
    ...
    <form method="POST" action="{{route('createDoctor')}}" class="container">
        ...
        <div class="inputDivs row justify-content-center w-75 mx-auto my-2">
            ...
            <input class="inputs" id="nameInput" type="text" placeholder="Nome" name="first_name" value="{{old('first_name')}}">
        </div>
        <div class="inputDivs row justify-content-center w-75 mx-auto my-2">
            <label for="surnameInput" class="text-center">Cognome</label>
            <input class="inputs" id="surnameInput" type="text" placeholder="Cognome" name="last_name" value="{{old('last_name')}}">
        </div>
        <div class="inputDivs row justify-content-center w-75 mx-auto my-2">
